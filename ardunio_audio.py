...
def play_blink_sound(arduino):
    arduino.write(b"B")

def play_alpha_sound(arduino):
    arduino.write(b"A")
...
def main():
    #initalize Arduino serial connection
    arduino = serial.Serial(ARDUINO_PORT, 115200, timeout=0)
    time.sleep(2)
